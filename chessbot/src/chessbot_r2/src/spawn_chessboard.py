...
if __name__=='__main__':
    ...
    unit=0.05
    with open("/home/mypc/ROSex/chessbot/src/chessbot_r2/src/chess_board.sdf","r")as f:
        board_xml=f.read()
    with open("/home/mypc/ROSex/chessbot/src/chessbot_r2/src/chess_piece.sdf","r")as f:
        piece_xml=f.read()

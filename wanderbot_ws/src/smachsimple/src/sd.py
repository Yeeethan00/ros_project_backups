...
from smash_ros import SimpleActionState
...
if __name__ == '__main__':
    ...
    patrol=StateMachine('success','aborted','preempted')
    with patrol:
	    ...
	    goal_pose=MoveBaseGoal()
            ...
            StateMachine.add(w[0],SimpleActionState('move_base',MoveBaseAction,goal=gol_pose),transitions={'success':waypoints[(i+1)%len(waypoints)][0]})

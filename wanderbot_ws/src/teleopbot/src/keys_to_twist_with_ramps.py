...
def send_twist():
  global g_twist_pub, g_target_twist, g_last_twist, g_last_twist_send_time, g_vel_scales, g_vel_ramps 
...
def fetch_param(name,default):
  if rospy.has_param(name):
    ...
    print "parameter [%s] not define. Defaulting to %.3f" %(name,default)
    return default

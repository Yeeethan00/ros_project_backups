...
(cl:defmethod cl:initialize-instance :after ((m <FakeSensor-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FakeSensor-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_sensor-srv:<FakeSensor-request> is deprecated: use my_sensor-srv:FakeSensor-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FakeSensor-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FakeSensor-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_sensor-srv:<FakeSensor-response> is deprecated: use my_sensor-srv:FakeSensor-response instead.")))

(cl:ensure-generic-function 'quaternion-val :lambda-list '(m))
(cl:defmethod quaternion-val ((m <FakeSensor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_sensor-srv:quaternion-val is deprecated.  Use my_sensor-srv:quaternion instead.")
  (quaternion m))

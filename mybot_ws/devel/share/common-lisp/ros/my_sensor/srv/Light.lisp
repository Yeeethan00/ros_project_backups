...
(cl:defmethod cl:initialize-instance :after ((m <Light-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Light-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_sensor-srv:<Light-request> is deprecated: use my_sensor-srv:Light-request instead.")))

(cl:ensure-generic-function 'on-val :lambda-list '(m))
(cl:defmethod on-val ((m <Light-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_sensor-srv:on-val is deprecated.  Use my_sensor-srv:on instead.")
  (on m))
...
(cl:defmethod cl:initialize-instance :after ((m <Light-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Light-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_sensor-srv:<Light-response> is deprecated: use my_sensor-srv:Light-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <Light-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_sensor-srv:status-val is deprecated.  Use my_sensor-srv:status instead.")
  (status m))

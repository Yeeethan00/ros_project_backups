...
class TalkActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TalkFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TalkFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TalkActionFeedback(null);
    ...
    data.feedback = TalkFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TalkActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TalkFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TalkFeedback()
    }
...
module.exports = TalkActionFeedback;

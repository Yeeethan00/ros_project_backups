...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#This is ana action definition file, which has three parts: the goal, the ~%#result,and the feedback~%#~%#Part 1: the goal, to be sent by the client~%#~%#The amount of time we want to wait ~%duration time_to_wait~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerGoal)))
  "Returns full string definition for message of type 'TimerGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#This is ana action definition file, which has three parts: the goal, the ~%#result,and the feedback~%#~%#Part 1: the goal, to be sent by the client~%#~%#The amount of time we want to wait ~%duration time_to_wait~%~%~%"))

...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#Part 3: the feesback, to be sent periodically by the server during execution~%#~%#The amount of time that has elapsed from the start~%duration time_elapsed~%#The amount of time remaining until we're done~%duration time_remaining ~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerFeedback)))
  "Returns full string definition for message of type 'TimerFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#Part 3: the feesback, to be sent periodically by the server during execution~%#~%#The amount of time that has elapsed from the start~%duration time_elapsed~%#The amount of time remaining until we're done~%duration time_remaining ~%~%~%~%"))

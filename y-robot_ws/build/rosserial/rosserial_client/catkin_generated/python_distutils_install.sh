...
echo_and_run cd "/home/mypc/ROSex/y-robot_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/mypc/ROSex/y-robot_ws/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/mypc/ROSex/y-robot_ws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \

...
void GraphManager::createOptimizer(std::string backend, g2o::SparseOptimizer* optimizer)
{
  ...
  if(ps->get<bool>("optimize_landmarks")){
    ...
    //g2o::OptimizationAlgorithmDogleg * algo = new g2o::OptimizationAlgorithmDogleg(solver_ptr);
     g2o::OptimizationAlgorithmDogleg * algo = new g2o::OptimizationAlgorithmDogleg(std::unique_ptr<g2o::BlockSolverX>(solver_ptr));
  ...
  else
  {
    ...
    if(backend == "cholmod" || backend == "auto"){
      ...
      solver = new SlamBlockSolver( std::unique_ptr<SlamBlockSolver::LinearSolverType>(linearSolver));
    ...
    g2o::OptimizationAlgorithmLevenberg * algo = new g2o::OptimizationAlgorithmLevenberg(std::unique_ptr<SlamBlockSolver>(solver));

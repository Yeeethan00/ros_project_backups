...
class MoveItDemo:
    def __init__(self):
        ...
        right_arm.set_end_effector_link('tool')
        ...
        #target_pose.pose.position.x = 0.00414375678912
        #target_pose.pose.position.y = -0.313023972364
        #target_pose.pose.position.z = 0.22717643205
        #target_pose.pose.orientation.x = 0.999862971641
        #target_pose.pose.orientation.y = 0.0067214932045
        #target_pose.pose.orientation.z = 0.00821975987572
        #target_pose.pose.orientation.w = 0.0127001975851

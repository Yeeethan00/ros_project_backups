...
(cl:defmethod cl:initialize-instance :after ((m <joint_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joint_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yrobot_home_bringup-msg:<joint_msg> is deprecated: use yrobot_home_bringup-msg:joint_msg instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <joint_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yrobot_home_bringup-msg:id-val is deprecated.  Use yrobot_home_bringup-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <joint_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yrobot_home_bringup-msg:r-val is deprecated.  Use yrobot_home_bringup-msg:r instead.")
  (r m))
